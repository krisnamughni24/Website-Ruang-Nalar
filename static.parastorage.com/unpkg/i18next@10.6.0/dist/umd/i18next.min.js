  ...
  function f() {
    return {
      ...
      overloadTranslationOptionHandler: function (t) {
        var e = {};
        return (
          t[1] && (e.defaultValue = t[1]), t[2] && (e.tDescription = t[2]), e
        );
      },
      interpolation: {
        escapeValue: !0,
  ...
  var d =
    ...
    w = (function () {
      ...
      return (
        ...
        (t.prototype.create = function (e) {
          return new t(
            this.logger,
            y({ prefix: this.prefix + ":" + e + ":" }, this.options)
          );
        }),
        t
      );
    ...
    j = (function (t) {
      ...
      return (
        ...
        (e.prototype.addResourceBundle = function (t, e, n, r, a) {
          var l =
            ...
            u = [t, e];
          t.indexOf(".") > -1 &&
            ((u = t.split(".")), (r = n), (n = e), (e = u[1])),
            this.addNamespaces(e);
          var c = i(this.data, u) || {};
          r ? s(c, n, a) : (c = y({}, c, n)),
            o(this.data, u, c),
            l.silent || this.emit("added", t, e, n);
        }),
    ...
    N = (function (t) {
      function n(o) {
        ...
        return (
          ...
          (i.options = r),
          (i.logger = O.create("translator")),
          i
        );
      }
      return (
        m(n, t),
        (n.prototype.changeLanguage = function (t) {
          t && (this.language = t);
        }),
        ...
        (n.prototype.extractFromKey = function (t, e) {
          ...
          if (n && t.indexOf(n) > -1) {
            var i = t.split(n);
            (n !== o || (n === o && this.options.ns.indexOf(i[0]) > -1)) &&
              (r = i.shift()),
              (t = i.join(o));
          }
        ...
        (n.prototype.translate = function (t, e) {
          ...
          var o = e.keySeparator || this.options.keySeparator || ".",
            ...
            u =
              e.appendNamespaceToCIMode || this.options.appendNamespaceToCIMode;
          ...
          var p = this.resolve(t, e),
            ...
            m =
              void 0 !== e.joinArrays ? e.joinArrays : this.options.joinArrays,
            b =
              "string" != typeof f &&
              "boolean" != typeof f &&
              "number" != typeof f;
          if (f && b && v.indexOf(h) < 0 && (!m || "[object Array]" !== h)) {
            ...
            if (e.keySeparator || this.options.keySeparator) {
              var x = "[object Array]" === h ? [] : {};
              for (var k in f)
                if (Object.prototype.hasOwnProperty.call(f, k)) {
                  var S = "" + g + o + k;
                  (x[k] = this.translate(
                    S,
                    y({}, e, { joinArrays: !1, ns: s })
                  )),
                    x[k] === S && (x[k] = f[k]);
                }
              f = x;
            }
          } else if (m && "[object Array]" === h)
            (f = f.join(m)), f && (f = this.extendTranslation(f, t, e));
          else {
            var w = !1,
              O = !1;
            this.isValidLookup(f) ||
              void 0 === e.defaultValue ||
              ((w = !0), (f = e.defaultValue)),
              this.isValidLookup(f) || ((O = !0), (f = i));
            var L =
              e.defaultValue &&
              e.defaultValue !== f &&
            ...
            if (O || w || L) {
              ...
              if ("fallback" === this.options.saveMissingTo && j && j[0])
                for (var C = 0; C < j.length; C++) R.push(j[C]);
              else
              ...
              this.options.saveMissing &&
                (this.options.saveMissingPlurals && e.count
                  ? R.forEach(function (t) {
                      var e = n.pluralResolver.getPluralFormsOfKey(t, i);
            ...
            (f = this.extendTranslation(f, t, e)),
              O &&
                f === i &&
        ...
        (n.prototype.extendTranslation = function (t, e, n) {
          ...
          this.options.interpolation.defaultVariables &&
            (r = y({}, this.options.interpolation.defaultVariables, r)),
                    ...
                    c.forEach(function (r) {
                      if (!e.isValidLookup(o)) {
                        var i = s,
                          a = [i],
                          c = void 0;
                        l && (c = e.pluralResolver.getSuffix(r, n.count)),
                          l && u && a.push(i + c),
                          u &&
                            a.push(
                              (i += "" + e.options.contextSeparator + n.context)
                            ),
                          l && a.push((i += c));
                        for (var p = void 0; (p = a.pop()); )
    ...
    U = (function () {
      function e() {
        ...
        v(this, e), (this.logger = O.create("interpolator")), this.init(t, !0);
      }
      return (
        (e.prototype.init = function () {
          ...
          e &&
            ...
            (this.escape = (t.interpolation && t.interpolation.escape) || l)),
            t.interpolation || (t.interpolation = { escapeValue: !0 });
          var n = t.interpolation;
          (this.escapeValue = void 0 === n.escapeValue || n.escapeValue),
            (this.prefix = n.prefix ? a(n.prefix) : n.prefixEscaped || "{{"),
            (this.suffix = n.suffix ? a(n.suffix) : n.suffixEscaped || "}}"),
            ...
            (this.nestingPrefix = n.nestingPrefix
              ? a(n.nestingPrefix)
              : n.nestingPrefixEscaped || a("$t(")),
            (this.nestingSuffix = n.nestingSuffix
              ? a(n.nestingSuffix)
              : n.nestingSuffixEscaped || a(")")),
        ...
        (e.prototype.interpolate = function (e, n, o) {
          ...
          var s = this,
            ...
            u = void 0,
            c = function (t) {
              if (t.indexOf(s.formatSeparator) < 0) return i(n, t);
              var e = t.split(s.formatSeparator),
                r = e.shift().trim(),
                a = e.join(s.formatSeparator).trim();
              return s.format(i(n, r), a, o);
            };
          for (
            this.resetRegExp(), u = 0;
          ...
          for (u = 0; (a = this.regexp.exec(e)); ) {
            if (((l = c(a[1].trim())), "string" != typeof l && (l = t(l)), !l))
              if (
                "function" == typeof this.options.missingInterpolationHandler
              ) {
                var p = this.options.missingInterpolationHandler(e, a);
                l = "string" == typeof p ? p : "";
              } else
                this.logger.warn(
                  ...
                  (l = "");
            if (
              ((l = r(this.escapeValue ? this.escape(l) : l)),
              (e = e.replace(a[0], l)),
        ...
        (e.prototype.nest = function (e, n) {
          ...
          var r =
            ...
            s = void 0,
            a = y({}, r);
          for (a.applyPostProcessor = !1; (i = this.nestingRegexp.exec(e)); ) {
            if (
              ((s = n(o.call(this, i[1].trim(), a), a)),
              s && i[0] === e && "string" != typeof s)
            )
              return s;
    ...
    H = (function (t) {
      function e(n, o, r) {
        var i =
          arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
        v(this, e);
        var s = b(this, t.call(this));
        return (
          (s.backend = n),
          (s.store = o),
          (s.languageUtils = r.languageUtils),
          (s.options = i),
          (s.logger = O.create("backendConnector")),
          (s.state = {}),
          (s.queue = []),
      ...
      return (
        ...
        (e.prototype.load = function (t, e, n) {
          ...
          var r = y({}, this.backend.options, this.options.backend);
          "string" == typeof t &&
            (t = this.languageUtils.toResolveHierarchy(t)),
            "string" == typeof e && (e = [e]);
          var s = this.queueLoad(t, e, n);
          return s.toLoad.length
        ...
        (e.prototype.reload = function (t, e) {
          ...
          var o = y({}, this.backend.options, this.options.backend);
          "string" == typeof t &&
            (t = this.languageUtils.toResolveHierarchy(t)),
            "string" == typeof e && (e = [e]),
            o.allowMultiLoading && this.backend.readMulti
              ? this.read(t, e, "readMulti", null, null, function (o, r) {
                  o &&
                    n.logger.warn(
          ...
          this.read(i, s, "read", null, null, function (o, r) {
            o &&
              ...
              !o &&
                r &&
                e.logger.log(
                  n + "loaded namespace " + s + " for language " + i,
                  r
                ),
              e.loaded(t, o, r);
          });
        ...
        (e.prototype.saveMissing = function (t, e, n, o, r) {
          ...
          this.backend &&
            this.backend.create &&
            this.backend.create(t, e, n, o, null, y({}, i, { isUpdate: r })),
    ...
    T = (function (t) {
      function e(n, o, r) {
        ...
        return (
          ...
          (s.services = r),
          (s.options = i),
          (s.logger = O.create("cacheConnector")),
          s.cache && s.cache.init && s.cache.init(r, i.cache, i),
          s
        );
      }
      return (
        ...
        (e.prototype.load = function (t, e, n) {
          ...
          var r = y({}, this.cache.options, this.options.cache),
            i =
              "string" == typeof t
                ? this.services.languageUtils.toResolveHierarchy(t)
                : t;
          r.enabled
            ? this.cache.load(i, function (t, e) {
                if (
                  (t &&
                    o.logger.error(
                      "loading languages " +
    ...
    V = (function (t) {
      function e() {
        ...
        if (
          ...
          var i;
          if (!r.options.initImmediate) return (i = r.init(n, o)), b(r, i);
          setTimeout(function () {
            r.init(n, o);
          }, 0);
        }
      ...
      return (
        ...
        (e.prototype.init = function () {
          ...
          if (
            ...
            (this.options = y({}, f(), this.options, g(n))),
            (this.format = this.options.interpolation.format),
            o || (o = h),
            !this.options.isClone)
          ) {
            this.modules.logger
              ? O.init(t(this.modules.logger), this.options)
              : O.init(null, this.options);
            var r = new E(this.options);
            this.store = new j(this.options.resources, this.options);
            var i = this.services;
            (i.logger = O),
              (i.resourceStore = this.store),
              i.resourceStore.on("added removed", function (t, e) {
                i.cacheConnector.save();
              }),
              (i.languageUtils = r),
              (i.pluralResolver = new M(r, {
              ...
              (i.cacheConnector = new T(
                t(this.modules.cache),
                i.resourceStore,
                i,
                this.options
              )),
              i.cacheConnector.on("*", function (t) {
                for (
                  var n = arguments.length, o = Array(n > 1 ? n - 1 : 0), r = 1;
                  r < n;
                  r++
              ...
              this.modules.languageDetector &&
                ((i.languageDetector = t(this.modules.languageDetector)),
        ...
        (e.prototype.getFixedT = function (t, e) {
          var n = this,
            o = function t(e, o) {
              for (
                var r = arguments.length, i = Array(r > 2 ? r - 2 : 0), s = 2;
                s < r;
                s++
              )
                i[s - 2] = arguments[s];
              var a = y({}, o);
              return (
                "object" !== ("undefined" == typeof o ? "undefined" : d(o)) &&
          ...
          return (
            "string" == typeof t ? (o.lng = t) : (o.lngs = t), (o.ns = e), o
          );
        }),
