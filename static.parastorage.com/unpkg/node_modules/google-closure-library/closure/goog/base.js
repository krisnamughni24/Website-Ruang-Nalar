 ...
 */
goog.DISALLOW_TEST_ONLY_CODE = goog.define(
 ...
 */
goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING = goog.define(
 ...
 */
goog.ASSUME_ES_MODULES_TRANSPILED = goog.define(
 ...
 */
goog.defineClass.SEAL_CLASS_INSTANCES = goog.define(
...
if (!COMPILED && goog.DEPENDENCIES_ENABLED) {
  ...
  goog.DebugLoader_.prototype.loadClosureDeps = function () {
    ...
    this.depsToLoad_.push(
      this.factory_.createDependency(
        goog.normalizePath_(goog.basePath + relPath),
        relPath,
        [],
        [],
        {},
  ...
  goog.DebugLoader_.prototype.areDepsLoaded_ = function (pathsOrIds) {
    for (var i = 0; i < pathsOrIds.length; i++) {
      ...
      if (
        !path ||
        (!(path in this.deferredCallbacks_) && !goog.isProvided_(pathsOrIds[i]))
      ) {
        return false;
      }
    }
  ...
  goog.Dependency.prototype.load = function (controller) {
    ...
    if (
      ...
      var eventName = goog.DebugLoader_.IS_OLD_IE_
        ? "onreadystatechange"
        : "onload";
      var event = "";
  ...
  goog.Es6ModuleDependency.prototype.load = function (controller) {
    ...
    function write(src, contents) {
      if (contents) {
        var script =
          '<script type="module" crossorigin>' + contents + "</" + "script>";
        doc.write(
          goog.TRUSTED_TYPES_POLICY_
            ? goog.TRUSTED_TYPES_POLICY_.createHTML(script)
            : script
  ...
  goog.DebugLoader_.prototype.addDependency = function (
    ...
    var dep = this.factory_.createDependency(
      ...
      goog.transpiler_.needsTranspile(
        opt_loadFlags["lang"] || "es3",
        opt_loadFlags["module"]
      )
    );
 ...
 * use Trusted Types.
 */
goog.TRUSTED_TYPES_POLICY_NAME = goog.define(
