 ...
 *     this is ON.
 */
goog.events.CAPTURE_SIMULATION_MODE = goog.define(
...
goog.events.handleBrowserEvent_ = function (listener, opt_evt) {
  ...
  if (!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
    var ieEvent =
      opt_evt || /** @type {Event} */ (goog.getObjectByName("window.event"));
    ...
    if (
      ...
      if (!goog.events.isMarkedIeEvent_(ieEvent)) {
        ...
        for (
          ...
          !evt.hasPropagationStopped() && i >= 0;
          i--
        ) {
          evt.currentTarget = ancestors[i];
          var result = goog.events.fireListeners_(
            ancestors[i],
            type,
            true,
            evt
        ...
        for (
          var i = 0;
          !evt.hasPropagationStopped() && i < ancestors.length;
          i++
        ) {
          evt.currentTarget = ancestors[i];
          var result = goog.events.fireListeners_(
