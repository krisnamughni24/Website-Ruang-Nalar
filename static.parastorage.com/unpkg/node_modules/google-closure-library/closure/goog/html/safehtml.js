 ...
 */
goog.html.SafeHtml.ENABLE_ERROR_MESSAGES = goog.define(
 ...
 * @define {boolean}
 */
goog.html.SafeHtml.SUPPORT_STYLE_ATTRIBUTE = goog.define(
...
goog.html.SafeHtml.htmlEscape = function (textOrHtml) {
  ...
  if (textIsObject && textOrHtml.implementsGoogI18nBidiDirectionalString) {
    dir = /** @type {!goog.i18n.bidi.DirectionalString} */ (
      textOrHtml
    ).getDirection();
  }
  var textAsString;
  if (textIsObject && textOrHtml.implementsGoogStringTypedString) {
    textAsString = /** @type {!goog.string.TypedString} */ (
      textOrHtml
    ).getTypedStringValue();
  } else {
  ...
  return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
    goog.string.internal.htmlEscape(textAsString),
    dir
  );
};
...
goog.html.SafeHtml.comment = function (text) {
  return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
    "<!--" + goog.string.internal.htmlEscape(text) + "-->",
    null
  );
};
...
goog.html.SafeHtml.createSandboxIframe = function (
  ...
  if (opt_src) {
    ...
    fixedAttributes["src"] = goog.html.SafeUrl.unwrap(
      goog.html.SafeUrl.sanitize(opt_src)
    );
  } else {
...
goog.html.SafeHtml.getAttrNameAndValue_ = function (tagName, name, value) {
  ...
  if (value.implementsGoogStringTypedString) {
    ...
    value = /** @type {!goog.string.TypedString} */ (
      value
    ).getTypedStringValue();
  }
...
goog.html.SafeHtml.join = function (separator, parts) {
  ...
  return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
    content.join(goog.html.SafeHtml.unwrap(separatorHtml)),
    dir
  );
};
