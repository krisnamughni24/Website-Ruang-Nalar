...
goog.scope(function () {
  ...
  goog.net.XhrIo.prototype.send = function (
    ...
    var contentTypeKey = goog.array.find(
      headers.getKeys(),
    ...
    if (
      goog.array.contains(goog.net.XhrIo.METHODS_WITH_FORM_DATA, method) &&
      !contentTypeKey &&
      !contentIsFormData
    ) {
  ...
  goog.net.XhrIo.prototype.cleanUpXhr_ = function (opt_fromDispose) {
    if (this.xhr_) {
      ...
      var xhr = this.xhr_;
      var clearedOnReadyStateChange = this.xhrOptions_[
  ...
  goog.net.XhrIo.prototype.getResponseHeaders = function () {
    ...
    for (var i = 0; i < headersArray.length; i++) {
      ...
      var keyValue = goog.string.splitLimit(
        headersArray[i],
        ":",
        /* maxSplitCount= */ 1
      );
  ...
  goog.net.XhrIo.prototype.getLastError = function () {
    return typeof this.lastError_ === "string"
      ? this.lastError_
