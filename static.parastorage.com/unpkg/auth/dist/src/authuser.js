...
fireauth.AuthUser = function (appOptions, stsTokenResponse, opt_accountInfo) {
  ...
  fireauth.object.setReadonlyProperty(
    this,
    "refreshToken",
    this.stsTokenManager_.getRefreshToken()
  );
  this.setAccountInfo(
    /** @type {!fireauth.AuthUser.AccountInfo} */ (opt_accountInfo || {})
  );
  ...
  this.multiFactorUser_ = new fireauth.MultiFactorUser(
    this,
    /** @type {?fireauth.AuthUser.AccountInfo|undefined} */ (opt_accountInfo)
  );
  fireauth.object.setReadonlyProperty(
    this,
    "multiFactor",
    this.multiFactorUser_
  );
};
 ...
 *     dispatcher.
 */
fireauth.AuthUser.prototype.setLanguageCodeChangeDispatcher = function (
  dispatcher
) {
 ...
 *     event dispatcher.
 */
fireauth.AuthUser.prototype.setEmulatorConfigChangeDispatcher = function (
  dispatcher
) {
  // Remove any previous listener.
 ...
 *     dispatcher.
 */
fireauth.AuthUser.prototype.setFrameworkChangeDispatcher = function (
  dispatcher
) {
  // Remove any previous listener.
...
fireauth.AuthUser.prototype.initializeProactiveRefreshUtility_ = function () {
  ...
  return new fireauth.ProactiveRefresh(
    ...
    function () {
      ...
      var waitInterval =
        self.stsTokenManager_.getExpirationTime() -
        Date.now() -
 ...
 */
fireauth.AuthUser.prototype.setRedirectStorageManager = function (
  redirectStorageManager
) {
  /**
...
fireauth.AuthUser.prototype.reload = function () {
  ...
  return this.registerPendingPromise_(
    this.checkDestroyed_().then(function () {
      return self
        .reloadWithoutSaving_()
        .then(function () {
...
fireauth.AuthUser.prototype.setUserAccountInfoFromToken_ = function (idToken) {
  return this.rpcHandler_
    .getAccountInfoByIdToken(idToken)
...
fireauth.AuthUser.prototype.parseAccountInfo_ = function (resp) {
  ...
  var isAnonymous =
    !(
      this["email"] && user[fireauth.AuthUser.GetAccountInfoField.PASSWORD_HASH]
  ...
  this.dispatchEvent(
    new fireauth.UserEvent(fireauth.UserEventType.USER_RELOADED, {
 ...
 * @return {!goog.Promise<!fireauth.AuthEventManager.Result>}
 */
fireauth.AuthUser.prototype.reauthenticateWithCredential = function (
  credential
) {
  var self = this;
  ...
  return this.registerPendingPromise_(
    ...
    credential
      .matchIdTokenWithUid(this.rpcHandler_, this["uid"])
      .then(function (response) {
...
fireauth.AuthUser.prototype.checkIfAlreadyLinked_ = function (providerId) {
  ...
  return this.reloadWithoutSaving_().then(function () {
    if (goog.array.contains(self.getProviderIds(), providerId)) {
      return self.notifyStateChangeListeners_().then(function () {
        throw new fireauth.AuthError(
 ...
 * @return {!goog.Promise<!fireauth.AuthEventManager.Result>}
 */
fireauth.AuthUser.prototype.linkAndRetrieveDataWithCredential = function (
  credential
) {
  fireauth.deprecation.log(
 ...
 */
fireauth.AuthUser.prototype.linkWithPhoneNumber = function (
  phoneNumber,
  appVerifier
) {
  var self = this;
  return /** @type {!goog.Promise<!fireauth.ConfirmationResult>} */ (
    this.registerPendingPromise_(
      ...
      // SMS (worth the cost).
      this.checkIfAlreadyLinked_(fireauth.idp.ProviderId.PHONE).then(
        function () {
 ...
 * @return {!goog.Promise<!fireauth.ConfirmationResult>}
 */
fireauth.AuthUser.prototype.reauthenticateWithPhoneNumber = function (
  phoneNumber,
  appVerifier
) {
  var self = this;
    ...
    this.registerPendingPromise_(
      ...
      goog.Promise.resolve().then(function () {
        return fireauth.ConfirmationResult.initialize(
          ...
          phoneNumber,
          appVerifier,
          goog.bind(self.reauthenticateWithCredential, self)
        );
      }),
 ...
 * @private
 */
fireauth.AuthUser.prototype.getUserCredential_ = function (
  idTokenResponse,
  operationType
) {
...
fireauth.AuthUser.prototype.unlink = function (providerId) {
  ...
  // Register this pending promise. This will also check for user invalidation.
  return this.registerPendingPromise_(
    this.reloadWithoutSaving_().then(function (idToken) {
      ...
      return self.rpcHandler_
        ...
        .then(function (resp) {
          ...
          var userInfo =
            resp[fireauth.AuthUser.SetAccountInfoField.PROVIDER_USER_INFO] ||
            [];
          ...
          if (
            !remainingProviderIds[fireauth.PhoneAuthProvider["PROVIDER_ID"]]
          ) {
...
fireauth.AuthUser.prototype.canHandleAuthEvent = function (mode, opt_eventId) {
  if (
    mode == fireauth.AuthEvent.Type.LINK_VIA_POPUP &&
    ...
    mode == fireauth.AuthEvent.Type.LINK_VIA_REDIRECT &&
    ...
    mode == fireauth.AuthEvent.Type.REAUTH_VIA_REDIRECT &&
    this.getRedirectEventId() == opt_eventId
  ) {
 ...
 * @override
 */
fireauth.AuthUser.prototype.resolvePendingPopupEvent = function (
  mode,
  popupRedirectResult,
  error,
  opt_eventId
 ...
 * @override
 */
fireauth.AuthUser.prototype.getAuthEventHandlerFinisher = function (
  mode,
  opt_eventId
) {
  if (
 ...
 * @private
 */
fireauth.AuthUser.prototype.runOperationWithPopup_ = function (
  mode,
  provider,
  additionalCheck,
  isReauthOperation
 ...
 * @private
 */
fireauth.AuthUser.prototype.runOperationWithRedirect_ = function (
  mode,
  provider,
  additionalCheck,
  isReauthOperation
 ...
 * @return {!goog.Promise<!fireauth.AuthEventManager.Result>}
 */
fireauth.AuthUser.prototype.finishPopupAndRedirectLink = function (
  requestUri,
  sessionId,
  tenantId,
  opt_postBody
 ...
 * @return {!goog.Promise<!fireauth.AuthEventManager.Result>}
 */
fireauth.AuthUser.prototype.finishPopupAndRedirectReauth = function (
  requestUri,
  sessionId,
  tenantId,
  opt_postBody
 ...
 * @return {!goog.Promise<void>}
 */
fireauth.AuthUser.prototype.sendEmailVerification = function (
 ...
 * @return {!goog.Promise<void>}
 */
fireauth.AuthUser.prototype.verifyBeforeUpdateEmail = function (
  newEmail,
  opt_actionCodeSettings
) {
  var self = this;
 ...
 * @private
 */
fireauth.AuthUser.prototype.registerPendingPromise_ = function (
  p,
  opt_skipInvalidationCheck
) {
  var self = this;
  ...
  // Return the promise.
  return processedP.thenCatch(function (error) {
 ...
 * @private
 */
fireauth.AuthUser.prototype.handleMultiFactorIdTokenResolver_ = function (
  response
) {
  var userCredential = null;
  var self = this;
 ...
 * @private
 */
fireauth.AuthUser.prototype.checkIfInvalidated_ = function (
  p,
  opt_skipInvalidationCheck
) {
  var self = this;
...
fireauth.AuthUser.fromPlainObject = function (user) {
  ...
  var firebaseUser = new fireauth.AuthUser(
    options,
  ...
  if (user["providerData"]) {
    goog.array.forEach(user["providerData"], function (userInfo) {
      if (userInfo) {
        firebaseUser.addProviderData(
          /** @type {!fireauth.AuthUserInfo} */ (
 ...
 * @return {!goog.Promise<!fireauth.AuthUser>}
 */
fireauth.AuthUser.initializeFromIdTokenResponse = function (
  appOptions,
  stsTokenResponse,
  opt_redirectStorageManager,
  opt_frameworks
) {
 ...
 */
fireauth.AuthUser.copyUser = function (
  user,
  opt_appOptions,
  opt_redirectStorageManager,
  opt_frameworks
  ...
  var newUser = new fireauth.AuthUser(
    appOptions,
    user.getStsTokenManager().toServerResponse()
  );
  // If redirect storage manager provided, set it.
  if (opt_redirectStorageManager) {
