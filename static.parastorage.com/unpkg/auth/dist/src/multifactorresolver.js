...
fireauth.MultiFactorResolver = function (
   ...
   */
  this.session_ = new fireauth.MultiFactorSession(null, pendingCredential);
  /**
  ...
  this.hints_ = [];
  var enrollmentList =
    errorResponse[fireauth.MultiFactorResolver.SignInResponseField.MFA_INFO] ||
    [];
  var self = this;
  ...
  fireauth.object.setReadonlyProperty(this, "hints", this.hints_);
};
...
fireauth.MultiFactorResolver.prototype.resolveSignIn = function (assertion) {
  var self = this;
  return assertion
    .process(this.auth_.getRpcHandler(), this.session_)
