...
fireauth.MultiFactorUser.prototype.handleUserReload_ = function (event) {
  this.updateEnrolledFactors_(
    fireauth.MultiFactorUser.extractEnrolledFactors_(event.userServerResponse)
  );
};
 ...
 * @private
 */
fireauth.MultiFactorUser.prototype.updateEnrolledFactors_ = function (
  enrolledFactors
) {
  this.enrolledFactors_ = enrolledFactors;
  fireauth.object.setReadonlyProperty(this, "enrolledFactors", enrolledFactors);
};
...
fireauth.MultiFactorUser.prototype.unenroll = function (target) {
  ...
  return this.user_
    ...
    .then(function (tokenResponse) {
      ...
      var enrolledFactors = goog.array.filter(
        self.enrolledFactors_,
        function (info) {
          return info["uid"] != uid;
        }
      );
