!(function (t, n, e, o, c, i, r, a, f) {
  function s(r) {
    if (!l) {
      ...
      const a = n.getElementsByTagName(e)[0],
        s = n.createElement(e);
      (s.src = "https://browser.sentry-cdn.com/5.7.1/bundle.min.js"),
        ...
        s.addEventListener("load", function () {
          try {
            ...
            (n.init = function (t) {
              ...
              (function (n, e) {
                try {
                  for (var i = y.data, r = 0; r < n.length; r++)
                    "function" == typeof n[r] && n[r]();
                  let a = !1,
                    f = t.__SENTRY__;
                  for (
                    void 0 !== f && f.hub && f.hub.getClient() && (a = !0),
                      f = !1,
                      r = 0;
                    r < i.length;
                    r++
  ...
  for (var p = !0, u = !1, d = 0; d < document.scripts.length; d++)
    if (
      -1 < document.scripts[d].src.indexOf("cbb1f5b485d944d2bf799cc46674093c")
    ) {
  ...
  t[o] = function (n, e, o, c, i) {
    y({ e: [].slice.call(arguments) }), b && b.apply(t, arguments);
  };
  var m = t[c];
  (t[c] = function (n) {
    y({ p: n.reason }), m && m.apply(t, arguments);
  }),
    p ||
      setTimeout(function () {
        s(h);
