  ...
  [5776],
  {
    ...
    67438: function (e, t, r) {
      ...
      function a(e) {
        ...
        var t = (
          ("object" == typeof consentPolicyManager &&
      ...
      function l(e) {
        ...
        for (var t = [], r = 0; r < localStorage.length; r++) {
          ...
          if (o.startsWith(e)) {
            ...
            t.push(
              (0, n.pi)(
                (0, n.pi)({ size: o.length + c.length, originalKey: o }, s(c)),
                u(o)
              )
            );
          }
      ...
      function p(e, t) {
        return (
          void 0 === t && (t = e.records[0]),
          localStorage.removeItem(t.originalKey),
          {
            records:
              t === e.records[0]
                ? e.records.slice(1)
                : e.records.filter(function (e) {
      ...
      function v(e) {
        var t = { records: l(), requiredSpace: e };
        !(function (e) {
            ...
            return (r = r && s(r)) && !f(r)
              ? ((function (e, t) {
                  ...
                  localStorage.setItem(
                    e,
                    S(t.value, { expiration: r, createdAt: n })
                  );
                })(n, r),
      ...
      function h(e) {
        return (
          [
            i.f1,
            e.namespace,
            ((t = e.scope), "string" == typeof t ? t : JSON.stringify(t)),
          ]
            .filter(function (e) {
              return e;
            })
