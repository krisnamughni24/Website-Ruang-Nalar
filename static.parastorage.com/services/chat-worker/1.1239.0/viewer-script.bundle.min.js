    ...
    var t = {
          ...
          var n,
                                ...
                                var e = t.data,
                                  r = (e =
                                    void 0 === e
                                      ...
                                      : e).success,
                                  o = e.results;
                                d.pubSub.unsubscribe(n),
                                  r ? a(o) : u(new Error("request failed"));
                              }),
                                d.pubSub.publish(
                                  t,
                                  i()({ requestId: String(r) }, e),
                                  !1
                                );
                            case 4:
                            case "end":
            ...
            x = function (t, e) {
              ...
              if (i || !a)
                throw new Error(
                  e +
                    " expect to get valid type (Business / Focused) or channelId"
                );
            },
            w = (function () {
              var t = u()(
                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            (t.next = 2),
                            v("ChatWidget.getChatState", {}, "chatrooms")
                          );
                        case 2:
                          return (
                            (e = t.sent),
            ...
            M = {
              onMessageReceived: function (t) {
                p(
                  ...
                  t,
                  b.MessageDirectionServer.BusinessToCustomer
                );
              },
              onMessageSent: function (t) {
                p(
                  ...
                  t,
                  b.MessageDirectionServer.CustomerToBusiness
                );
              },
            ...
            E = {
              ...
              startPrivateChat: function (t) {
                return y("ChatWidget.startPrivateChat", { userId: t });
              },
            },
            _ = i()({}, M, E),
            L = function (t) {},
            ...
            T = function (t, e) {
              ...
              })({ instance: t.instance }, { pubSub: e.pubSub });
            };
        },
        944: function (t, e, r) {
          var n = r(266);
        ...
        388: function (t, e, r) {
          ...
          e.C = function (t) {
            ...
            return {
              id: e,
              displayData: u
                ? { image: s, name: i, initials: a }
                : { image: s, name: i },
              messages: [
                (0, n.transformMessage)(
                  r,
                  o.MessageDirectionServer.CustomerToBusiness
                ),
              ],
            };
          };
        ...
        810: function (t, e, r) {
          ...
          e.transformMessage = function (t, e) {
            var r = (t.data && t.data[0] && t.data[0].data.text) || void 0,
              o = t.metadata || void 0,
              i =
                e === n.MessageDirectionServer.CustomerToBusiness
                  ? "VisitorToBusiness"
                  : "BusinessToVisitor",
              a = r ? "TEXT" : void 0,
              u = t.summary,
              ...
              f = {};
            o &&
              (f = Object.keys(o).reduce(function (t, e) {
                try {
                  t[e] = JSON.parse(o[e]);
                } catch (r) {
                  t[e] = o[e];
        ...
        833: function (t, e) {
          ...
          Object.defineProperty(e, "__esModule", { value: !0 }),
            ...
            (function (t) {
              (t.CustomerToBusiness = "CUSTOMER_TO_BUSINESS"),
                (t.BusinessToCustomer = "BUSINESS_TO_CUSTOMER");
