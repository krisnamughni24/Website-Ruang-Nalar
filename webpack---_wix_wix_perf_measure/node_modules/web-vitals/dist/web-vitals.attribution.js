var e,
    ...
    (t = t || {}),
      w(function () {
        var n,
          ...
          i = L(),
          a = m("FCP"),
          o = v("paint", function (e) {
            e.forEach(function (e) {
              "first-contentful-paint" === e.name &&
                (o.disconnect(),
                e.startTime < i.firstHiddenTime &&
                  ((a.value = Math.max(e.startTime - l(), 0)),
                  a.entries.push(e),
                  n(!0)));
            });
          });
        o &&
          ((n = p(e, a, r, t.reportAllChanges)),
          d(function (i) {
            (a = m("FCP")),
              (n = p(e, a, r, t.reportAllChanges)),
              h(function () {
            ...
            var n,
              ...
              u = function (e) {
                e.forEach(function (e) {
                  ...
                  a > i.value && ((i.value = a), (i.entries = o), n());
              },
              c = v("layout-shift", u);
            c &&
  ...
  I = new Date(),
  B = function (r, i) {
    e || ((e = i), (t = r), (n = new Date()), k(removeEventListener), D());
  },
  D = function () {
    if (t >= 0 && t < n - I) {
      var i = {
      ...
      w(function () {
        ...
        var r,
          ...
          a = function (e) {
            ...
            var t,
              n = ((t = Math.min(G.length - 1, Math.floor(z() / 50))), G[t]);
            n &&
              n.latency !== i.value &&
              ((i.value = n.latency), (i.entries = n.entries), r());
          },
          o = v("event", a, { durationThreshold: t.durationThreshold || 40 });
        (r = p(e, i, n, t.reportAllChanges)),
          o &&
        ...
        w(function () {
          var n,
            ...
            o = function (e) {
              var t = e[e.length - 1];
              if (t) {
                var r = Math.max(t.startTime - l(), 0);
                r < i.firstHiddenTime &&
          ...
          if (u) {
            ...
            var c = T(function () {
              X[a.id] ||
                (o(u.takeRecords()), u.disconnect(), (X[a.id] = !0), n(!0));
            });
  ...
  $ = function (e, t) {
    ...
    var n = [800, 1800],
      r = m("TTFB"),
      i = p(e, r, n, t.reportAllChanges);
    Z(function () {
      var o = a();
      if (o) {
        var u = o.responseStart;
        if (u <= 0 || u > performance.now()) return;
        (r.value = Math.max(u - l(), 0)),
          (r.entries = [o]),
          i(!0),
          d(function () {
            (r = m("TTFB", 0)), (i = p(e, r, n, t.reportAllChanges))(!0);
          });
      }
    });
  },
