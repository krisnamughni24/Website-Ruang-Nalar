...
exports.getTransformers =
  ...
  exports.postMessagePublisher =
  exports.xhrPublisher =
  exports.fetchPublisher =
  exports.beaconPublisher =
  exports.imagePublisher =
  exports.resolvePublisher =
    void 0;
...
function imagePublisher(options) {
  ...
  return function image(params, context) {
    ...
    if (context.useBatch) {
      throw new errors_1.APINotSupportedError(
...
function beaconPublisher(options) {
  ...
  return function beacon(params, context) {
    ...
    var url = (0, utils_1.buildBiUrl)(options, params, context);
    return (0, transport_1.beaconTransport)(
      url,
      params,
      !!context.useBatch
    ).catch(function () {
      ...
      return context.useBatch
        ? (0, transport_1.fetchTransport)(url, params, method).catch(function (
            error
          ) {
...
function fetchPublisher(options, fetchFunction) {
  ...
  return function fetch(params, context) {
    ...
    var url = (0, utils_1.buildBiUrl)(options, params, context);
    var method = getHttpMethod(context);
    return (0, transport_1.fetchTransport)(
      url,
      params,
      method,
      fetchFunction
    ...
    if (publisherContext.useBatch) {
      ...
      params.e = params.e.map(function (e) {
        ...
        var res = __assign(__assign({}, event), {
          f: __assign(__assign({}, event.f), { _rp: getEndpoint_1(context) }),
        });
        return res;
      });
    }
