...
exports.BiLoggerClientFactory =
  exports.createBatchQueue =
  exports.manager =
  exports.factory =
  exports.Factory =
  exports.setHost =
  exports.EventCategories =
  exports.PublishMethods =
    void 0;
...
var Factory = /** @class */ (function () {
    ...
    assert.ok(
      !options.publishMethod ||
        Object.keys(types_1.PublishMethods)
          ...
          .indexOf(options.publishMethod) !== -1,
      'Unsupported publish method "'.concat(options.publishMethod, '"')
    );
    Factory.consentPolicyAccessor =
      Factory.consentPolicyAccessor ||
      new consent_policy_client_accessor_1.ConsentPolicyAccessor();
  ...
  Factory.prototype.initFactory = function () {
    ...
    this.updateDefaults(
      (0, event_defaults_1.getCommonDefaults)(
    ...
    var options = __assign(__assign({}, this.options), {
      host:
        this.options.host ||
        function () {
          return (0, env_1.getHost)(
            (0, common_config_1.getBrand)(_this.commonConfigGetter)
          );
        },
    });
    var publisher = (0, publishers_1.getPublisher)(
      options,
  ...
  Factory.prototype.withTransformer = function (transformer) {
    ...
    assert.ok(
      typeof transformer === "function" ||
        (transformer &&
          typeof transformer[types_1.PublishMethods.PostMessage] ===
            "function"),
  ...
  Factory.prototype.withPublishFunction = function (publishFunctions) {
    assert.defined(
      publishFunctions,
      "Publish functions object must be provided"
    );
    assert.ok(
      this.options.publishMethod &&
        this.options.publishMethod !== types_1.PublishMethods.Auto,
      "Publish function can be used only when using a custom publish method"
    );
    assert.ok(
      publishFunctions &&
        typeof publishFunctions[this.options.publishMethod] === "function",
  ...
  Factory.prototype.withNonEssentialContext = function (context) {
    ...
    this.loggerClientFactory.updateNonEssentialDefaults(
      (0, event_defaults_1.transformDefaults)(context)
    );
    return this;
  };
  Factory.prototype.withCommonConfigGetter = function (commonConfigGetter) {
    ...
    assert.ok(
      typeof commonConfigGetter === "function",
  ...
  Factory.prototype.logger = function (options) {
    ...
    var logger = this.initFactory().logger(
      __assign({ endpoint: endpoint, useBatch: useBatch }, options)
    );
    return logger;
  };
  return Factory;
