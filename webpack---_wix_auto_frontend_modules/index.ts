...
const wixAuthenticationManagementV2Loader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixCategoriesBackendLoader = (
  context: WixCodeApiFactoryArgs,
): Promise<any> =>
  import(
...
const wixEmailMarketingBackendLoader = (
  context: WixCodeApiFactoryArgs,
): Promise<any> =>
  import(
